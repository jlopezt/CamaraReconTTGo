...
class salida
  ...
  void inicializaSalida(int8_t config, String nom, int8_t est, int8_t p, int8_t sec, unsigned long finP,int8_t ini);
...
class SalidasClass
  ...
  int8_t releConfigurado(uint8_t id);
  ...
  int8_t asociarSecuenciador(int8_t id, int8_t plan);
